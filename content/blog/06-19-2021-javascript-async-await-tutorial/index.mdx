...
![异步系统](https://media.giphy.com/media/MMDnmJnE7uhX6KtcKc/giphy.gif)
...
# 原文
  ...
  成品： [JavaScript Async/Await 教程——通过制作冰淇淋来学习 JavaScript 异步编程](https://chinese.freecodecamp.org/news/javascript-async-await-tutorial-learn-callbacks-promises-async-await-by-making-icecream/)
